...
碩士生申請前請先閱讀 Nielsen 與 Chuang 的 _Quantum Computation and Quantum Information_：請讀完**第 1–6 章及第 9–10 章**；若尚未完成全部章節，申請前至少須讀完**第 1–4 章**。

本實驗室的研究方向偏理論。原則上，申請者需修過**複變函數**與**兩學期量子物理**；若未修過，請至我的辦公室接受面談，我會從大一、大二程度的**微積分或應用數學**中出 1–3 題進行考核。未符合上述條件者，原則上不予錄取。

若申請者具備 **Python 或 C++** 程式能力、已完成 **LeetCode 100–200 題**、修過**演算法與資料結構**，並通過我的面試，則可不受上述修課條件限制。
